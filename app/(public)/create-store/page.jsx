...
export default function CreateStore() {
    ...
    const fetchSellerStatus = async () => {
        ...
        try {
            ...
            if (['approved', 'pending', 'rejected'].includes(statusLower)) {
                ...
                switch (statusLower) {
                    case "approved":
                        ...
                        break;
                    case "pending":
                        setMessage("Your store application is pending. Please wait for approval.")
                        break;
                    case "rejected":
                ...
                <div className="mx-6 min-h-[70vh] my-16">
                    ...
                    >
                        ...
                        <div>
                            ...
                            <p className="max-w-lg">To become a seller on ShopVibe, submit your store details for review. Your store will be activated after admin verification.</p>
                        </div>
